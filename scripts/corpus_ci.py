...
from skylos.corpus_ci import format_summary, run_manifest
...
def main() -> int:
    ...
    parser.add_argument(
        "--manifest",
        default=str(Path("corpus") / "manifest.json"),
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Run only the specified corpus case id. Repeat for multiple ids.",
    )
    parser.add_argument(
        "--json",
        action="store_true",
